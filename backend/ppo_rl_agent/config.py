...
norm_params: dict[str, dict] = {
    ...
    "vehicle_to_edge_throughput": {"min": 10.0, "max": 1000.0},
    "edge_to_edge_throughput": {"min": 10.0, "max": 1000.0},
    "edge_to_cloud_throughput": {"min": 10.0, "max": 1000.0},
    "edge_to_vehicle_throughput": {"min": 10.0, "max": 1000.0},
    "cloud_to_edge_throughput": {"min": 10.0, "max": 1000.0},
